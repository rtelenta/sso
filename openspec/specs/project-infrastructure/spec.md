...
Defines the foundational project infrastructure conventions including environment variable management, UI component setup, client-side data fetching, and the canonical directory layout.
