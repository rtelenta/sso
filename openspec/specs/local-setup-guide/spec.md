# Spec: Local Setup Guide

## Purpose

Defines the requirements for `docs/local-setup.md` — a detailed guide that walks developers through every step needed to run the SSO platform locally.
