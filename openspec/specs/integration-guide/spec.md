...
Defines the developer-facing integration guide (`docs/integration-guide.md`) that explains how a downstream application integrates with the SSO service using the OAuth2 Authorization Code flow.
