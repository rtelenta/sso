# Spec: bruno-collection

## Purpose

Defines the Bruno API collection that ships with the repository, giving developers runnable examples for every SSO API endpoint without requiring Postman or any other GUI tool.
